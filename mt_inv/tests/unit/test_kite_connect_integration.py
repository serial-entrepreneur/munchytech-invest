...
from mt_inv.data_ingestion.kite_connect_integration import authenticate, fetch_historical_data
...
def test_fetch_historical_data_success(mock_kite):
    ...
    result = fetch_historical_data("instrument_token", "2023-01-01", "2023-01-31", "day")
    assert result == mock_data
    mock_kite.historical_data.assert_called_once_with("instrument_token", "2023-01-01", "2023-01-31", "day")
